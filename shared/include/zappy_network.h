...
EXPORT extern bool zappy_init_connector(char *address,
					uint16_t port, bool thread_sync,
					gui_handlers_t handlers);
EXPORT extern bool zappy_init_connector_ai(char *address,
					uint16_t port, bool thread_sync,
